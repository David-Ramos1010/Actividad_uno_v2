...
En este ejercicio se añadieron nuevos campos de texto y una manera mas rápida de modificar los colores de la pagina sin ir uno a uno. No entendí muy bien para que servía la siguiente API:
